...
from src.utils.videoio import save_frames_as_video, save_video_with_watermark
...
class AnimateFromCoeff():
    ...
    def generate(self, x, video_save_dir, pic_path, crop_info, enhancer=None, background_enhancer=None, preprocess='crop', img_size=256):
        ...
        save_frames_as_video(path, result, fps=25)
        ...
        if enhancer:
            ...
            try:
                ...
                save_frames_as_video(enhanced_path, enhanced_images_gen_with_len, fps=25)
            except:
